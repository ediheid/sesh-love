...
const baseNavItems: NavItem[] = [
  {
    ...
    altText:
      'Four ferrets with brown, white, and grey fur sit closely together, facing the camera.',
  },
  {
    to: '/training',
    label: 'training',
    ...
    altText:
      'Jane Fonda wearing a yellow aerobics leotard with capped sleeves and frills, and yellow leg warmers with purple cuffs, seated in an aerobics pose with one leg raised.',
  },
  {
    to: '/upcoming',
    label: 'upcoming',
